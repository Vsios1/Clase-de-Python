...
class Kernel:
    ...
    def _post_run(self, nivel, p):
        ...
        quantum_nivel = self.quanta[min(nivel, self.num_niveles - 1)]
        if self.quantum_consumido[p.pid] >= quantum_nivel:
            self.quantum_consumido[p.pid] = 0
    ...
    def estadisticas(self):
        ...
        uso_cpu = sum(1 for _ in range(total_tiempo))
